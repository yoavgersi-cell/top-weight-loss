...
const seedTrustpilot: Record<string, { rating?: string; reviewCount?: string; reviews: TrustpilotReview[] }> = {
  ...
  altrx: {
    reviews: [
      ...
      },
      {
        ...
        text: "I do not understand how everyone has all of these “negative” reviews. I was skeptical at first due to reading through these but I am very happy with this company. 3 of my other coworkers use them as well and they are happy as well.",
        name: "Angela",
        location: "US",
        rating: 5,
        date: "Sep 2, 2026",
      ...
      {
        title: "So far so good!",
        text: "I joined in June 2026. At first I was worried cause the ad I saw said $129 a month for tirzepatide but when I signed up they said it was an error and it would be $149 a month forever. And so far it's been great. My dose has increased but my price hasn't. I haven't had any trouble with communication via messaging them. My experience so far has been great, but I am not a social person I appreciate them checking up on me monthly and not annoying me with weekly check ins.",
        name: "ZC",
        location: "US",
        rating: 5,
        date: "Jun 16, 2026",
  ...
  ro: {
    // Aggregate re-verified Sep 24, 2026 from Ro's claimed Trustpilot profile
    // (operator-supplied screenshot): 3.9 across 6,690 reviews, Online
    // Pharmacy category, claimed Nov 2021. (Was 4.0 / 6,428 earlier in Sep.)
    rating: "3.9",
    reviewCount: "6,690",
    reviews: [
      // Sep 24, 2026 batch (operator-supplied screenshots of the profile's
      // newest reviews, Sep 16-24 2026). Transcribed faithfully; reviewer
      // names reduced to first name + last initial.
      {
        title: "Exceptional in every respect!!!",
        text: "Exceptional in every respect!!!",
        name: "Steve P.",
        location: "US",
        rating: 5,
        date: "Sep 24, 2026",
      ...
      {
        title: "So far, so good!",
        text: "So far, so good! Can't wait to receive my first order!",
        name: "Marsha W.",
        location: "US",
        rating: 5,
        date: "Sep 21, 2026",
      ...
      {
        title: "Good but lack personal support",
        text: "I'd like to be able to chat directly with someone. All I can find are FAQ with responses.",
        name: "Lisa R.",
        location: "US",
        rating: 4,
        date: "Sep 21, 2026",
      ...
      {
        title: "I had to choose a medication without...",
        text: "I had to choose a medication without any guidance from a physician. I thought I would receive some input before my medication was ordered, but I was charged before I even talked to a physician about possible side effects/benefits.",
        name: "Tracy",
        location: "US",
        rating: 2,
        date: "Sep 21, 2026",
      ...
      {
        title: "I wish you had a phone # for better...",
        text: "I wish you had a phone # for better communication.",
        name: "Elizabeth M.",
        location: "US",
        rating: 3,
        date: "Sep 22, 2026",
      ...
      {
        title: "The process was relatively easy and the...",
        text: "The process was relatively easy and the site seems legitimate. But the pricing is dicey - I already saw a second charge for some kind of subscription in addition to the monthly charge! I find that very questionable and now I'm seeing reviews that the billing process is not consistent. I'm not thrilled.",
        name: "Janet C.",
        location: "US",
        rating: 3,
        date: "Sep 22, 2026",
      ...
      {
        title: "Received the smallest dosage of GLP-1...",
        text: "Received the smallest dosage of GLP-1 amongst my many, many friends who started this program. Half of what the rest received from other platforms.",
        name: "Shane D.",
        location: "US",
        rating: 3,
        date: "Sep 22, 2026",
      ...
      {
        title: "Needed to contact Ro by phone to...",
        text: "Needed to contact Ro by phone to expedite delivery. Impossible! Video call with MD a mere short formality. Messages returned in 2-3 business days.",
        name: "Gary G.",
        location: "US",
        rating: 2,
        date: "Sep 22, 2026",
      ...
      {
        title: "My delivery was delayed for 4 days",
        text: "My delivery was delayed for 4 days. When I received it all of the ice packs were totally melted into liquid. The temperature of the box was 60 degrees inside. The first response I received, after I notified them of my delivery, was to not use the medication and that they would review the problem. Now I have been getting emails saying \"your medication has been delivered\" and I have not had any further information as to whether I should use it or not. Very frustrating and poor customer service",
        name: "John",
        location: "US",
        rating: 2,
        date: "Sep 22, 2026",
      ...
      {
        title: "I am still waiting for shipping...",
        text: "I am still waiting for shipping verification.",
        name: "Robyn M.",
        location: "US",
        rating: 3,
        date: "Sep 21, 2026",
      ...
      {
        title: "Would be nice to know the possible fee...",
        text: "Would be nice to know the possible fee for medication before paying the $39.",
        name: "Shelly",
        location: "US",
        rating: 3,
        date: "Sep 20, 2026",
      ...
      {
        title: "I didn't understand that $39 initial...",
        text: "I didn't understand that $39 initial fee was for consultation and not the medicine. Needs to be clearer about what the cost was for",
        name: "Norma P.",
        location: "US",
        rating: 2,
        date: "Sep 19, 2026",
      ...
      {
        title: "Applying for RO was quick and easy",
        text: "Applying for RO was quick and easy. I got a response within an hour! I have had a follow up from a doctor who explained the process, the medication and usage. Also, it is very comforting to know that there are professionals available should there be questions.",
        name: "Carol",
        location: "US",
        rating: 5,
        date: "Sep 22, 2026",
      ...
      {
        title: "My new experience with GLP-1 w/ro",
        text: "My experience with ro was great, just as if I was in with my primary care physician. They asked all necessary questions about my health and meds I take daily, so I'm confident in my experience. Thanks ro",
        name: "Marsha",
        location: "US",
        rating: 5,
        date: "Sep 22, 2026",
      },
      {
        ...
        text: "The whole process was so quick and easy. I was pleasantly surprised.",
        name: "Tony L.",
        location: "US",
        rating: 5,
        date: "Sep 22, 2026",
      ...
      {
        title: "They are easy to take",
        text: "They are easy to take and so far I haven't had any side effects.",
        name: "Joan M.",
        location: "US",
        rating: 5,
        date: "Sep 16, 2026",
      ...
      {
        title: "They are good to answer questions...",
        text: "They are good to answer questions quickly and not leave you hanging.",
        name: "James C.",
        location: "US",
        rating: 5,
        date: "Sep 22, 2026",
  ...
  trimrx: {
    ...
    reviews: [
      ...
      {
        title: "The tracking date moved twice and the...",
        text: "The tracking date moved twice and the box came three days late, and the cold packs were warm to the touch when I finally opened it.",
        name: "Holly H.",
        location: "US",
        rating: 2,
        date: "Sep 23, 2026",
      ...
      {
        title: "The medication was not working for me",
        text: "The medication was not working for me, so I canceled my prescription but I am still receiving text and emails from Affirm saying they have not received cancellation from trim rx and is trying to continue charging me each month.",
        name: "George L.",
        location: "US",
        rating: 2,
        date: "Sep 23, 2026",
      ...
      {
        title: "The price runs a little high",
        text: "The price runs a little high, but if the quality holds I don't mind paying it. Delivery has been great every time and the whole thing is easy to follow. So far it's going well. The only frustrating part is those weeks where the scale just sits, though I knew that would happen.",
        name: "Tiffany C.",
        location: "US",
        rating: 3,
        date: "Sep 22, 2026",
      ...
      {
        title: "Unreliable! Potentially crooks!",
        text: "The onboarding process was fine, telehealth etc. They processed my order AND full payment very quickly. I signed up for a 6-month plan which delivers in two deliveries. First upon approval and second 3 months later. I've not received the second order; which I already paid for, and it's over 30 days late. They do not respond on their website chat or answer the phone when called. I've been trying to contact someone for 10 days. I finally ended up disputing with my CC company.",
        name: "Karen A.",
        location: "US",
        rating: 2,
        date: "Sep 21, 2026",
      ...
      {
        title: "Whoever was helping me answered my...",
        text: "Whoever was helping me answered my questions and followed up after, and communication has been solid the whole way. My one gripe is it was supposed to arrive in 48 hours and it actually took 5 days.",
        name: "Michael H.",
        location: "US",
        rating: 4,
        date: "Sep 21, 2026",
      ...
      {
        title: "This is my first order with TrimRX",
        text: "This is my first order with TrimRX. I've not even received the order and I'm already having problems. The RX that was sent to my patient portal was not even me. I tried to reach out via chat....nothing. Email? No response. The phone call was automated and someone should be reaching out to me soon. I've yet to hear back. Email codes are not being received by me and the charge on my next bill is double what they'd told me initially. $399 for a month of Tirzepatide? I could purchase Mounjaro for less. In the meantime....rx has been shipped out without anyone contacting me about the incorrect rx information. Very very dissatisfied and will not be ordering from them again. Too much of a hassle.",
        name: "Mrs V",
        location: "US",
        rating: 2,
        date: "Sep 20, 2026",
  ...
  medvi: {
    // Aggregate re-verified Sep 25, 2026 from MEDVi's claimed Trustpilot
    // profile (operator-supplied screenshot): 4.3 across 14,836 reviews,
    // Weight Loss Service category, claimed Jan 2025. (Was 4.4 / 14,372.)
    rating: "4.3",
    reviewCount: "14,836",
    reviews: [
      // Sep 25, 2026 batch (operator-supplied screenshots, newest reviews
      // Aug 30 - Sep 25 2026): six 5-star, five 4-star. Same transcription
      // rules; the 4-star middle was previously missing from this record.
      {
        title: "Keep your appointment",
        text: "Very helpful information. Theresa was thoughtful and explained all of her observations.",
        name: "Eric B.",
        location: "US",
        rating: 5,
        date: "Sep 25, 2026",
      ...
      {
        title: "Nurse was very informative and pleasant",
        text: "Nurse was very informative and pleasant to talk with.",
        name: "Stephen V.",
        location: "US",
        rating: 5,
        date: "Sep 25, 2026",
      ...
      {
        title: "This journey has been great",
        text: "This journey has been great . Talking with Jessica certainly has answered my questions and concerns.",
        name: "Linda H.",
        location: "US",
        rating: 5,
        date: "Sep 25, 2026",
      ...
      {
        title: "My provider was very helpful",
        text: "My provider was very helpful. She listened to my concerns and made proper adjustments.",
        name: "Crystal C.",
        location: "US",
        rating: 5,
        date: "Sep 24, 2026",
      ...
      {
        title: "Tomica",
        text: "Tomica, the company rep was outstanding.",
        name: "John W.",
        location: "US",
        rating: 5,
        date: "Sep 24, 2026",
      ...
      {
        title: "I was able to ask any questions",
        text: "I was able to ask any questions, she was very informative.",
        name: "Maria A.",
        location: "US",
        rating: 5,
        date: "Sep 24, 2026",
      ...
      {
        title: "Very personal",
        text: "Very personal, communicated all needs and supported me with advice",
        name: "Roxanne C.",
        location: "US",
        rating: 4,
        date: "Sep 22, 2026",
      ...
      {
        title: "Helpful personnel",
        text: "Helpful personnel.",
        name: "Vivian H.",
        location: "US",
        rating: 4,
        date: "Sep 5, 2026",
      ...
      {
        title: "At first had a hard time canceling my monthly subscription",
        text: "At first had a hard time canceling my monthly subscription, but they did finally get that taken care of. The product is great, I just didnt need/want a monthly prescription. I wish they had more flexibility in that regard. Maybe an every other month, or just buy as needed.",
        name: "Chris W.",
        location: "US",
        rating: 4,
        date: "Sep 4, 2026",
      ...
      {
        title: "GLP-1 (Compounded)",
        text: "MEDVi offers a lot of assistance with the RN, Provider. and Coaching Support - I like that assistance. However, they need to ensure for a solid audio-video connection to see whom you're speaking with (there's too much FRAUD going on today) especially when it comes to your health. It's very important to see and get there credentials/whom you're speaking with about your health - you know, the HIPPA ACT Policy. Otherwise, I really enjoy this Rx, it really curves your appetite. My PRAYER is NO side effects so that I can continue and accomplish my goal. I started this program in March 2026. It cost too much not to receive stellar service.",
        name: "A Concerned First Time Consume",
        location: "US",
        rating: 4,
        date: "Aug 31, 2026",
      },
...
const defaultReviews: ReviewData[] = [
  ...
  },
  {
    ...
    pros: [
      "4.3 across 14,836 Trustpilot reviews - one of the two largest verified records in our ranking",
...
const healthrxMedviBattle: BattleData = {
  ...
  categories: [
    ...
    },
    {
      ...
      winner: "provider1",
      explanation:
        "Medvi's 4.3 across 14,836 Trustpilot reviews - repeatedly praising thorough providers and personal service - is the kind of evidence a newer brand simply can't match yet. HealthRx's program design looks right (LegitScript-certified, clinician-gated), but its public review record is still thin.",
      supportingPoints: [
        "4.3/5 across 14,836 Trustpilot reviews (Medvi)",
  ...
  features: [
    ...
    { feature: "Trustpilot", provider1Value: "4.3 across 14,836 reviews", provider2Value: "Newer brand", highlight: "provider1" },
        ...
        editorialSections: [
          {
            ...
            body: 'Semaglutide is a GLP-1 receptor agonist - a medication that mimics a natural gut hormone to reduce appetite and regulate blood sugar. Originally developed for type 2 diabetes (as Ozempic), it was later approved for chronic weight management under the brand name Wegovy. Learn more about <a href="/weight-loss/articles/how-glp1-medications-work">how GLP-1 medications work</a>.',
          },
          {
            heading: "Semaglutide Weight Loss Results",
            body: 'In the STEP clinical trials, patients taking semaglutide lost an average of 15% of their body weight over 68 weeks. Results vary by individual, but most patients begin noticing reduced appetite within the first two weeks. Read our guide on <a href="/weight-loss/articles/first-month-weight-loss-medication">what to expect your first month</a>.',
          },
          {
            heading: "How to Choose a Semaglutide Provider",
            body: 'Not all providers are equal - pricing, medical oversight, and medication quality can vary significantly. We evaluated each provider on transparency, clinical support, and overall value. For detailed guidance, read our article on <a href="/weight-loss/articles/choosing-telehealth-weight-loss-provider">choosing the right telehealth provider</a>.',
          ...
          },
          {
            ...
            body: 'Wondering how semaglutide compares to the newer dual-agonist tirzepatide? Both are effective, but they work differently. Read our full <a href="/weight-loss/articles/tirzepatide-vs-semaglutide">semaglutide vs tirzepatide comparison</a>, or see our <a href="/weight-loss/tirzepatide">tirzepatide providers page</a> for alternatives.',
          },
        ],
      },
      {
        ...
        editorialSections: [
          {
            ...
            body: 'Tirzepatide is a dual-agonist medication that targets both GLP-1 and GIP receptors - making it unique among weight loss medications. It\'s the active ingredient in Mounjaro (for diabetes) and Zepbound (for weight loss). Learn more about <a href="/weight-loss/articles/how-glp1-medications-work">how GLP-1 medications work</a>.',
          },
          {
            heading: "Tirzepatide Weight Loss Results",
            body: 'The SURMOUNT clinical trials showed tirzepatide patients lost up to 22.5% of their body weight at the highest dose over 72 weeks - making it the most effective GLP-1 medication for weight loss currently available. For a head-to-head breakdown, read our <a href="/weight-loss/articles/tirzepatide-vs-semaglutide">tirzepatide vs semaglutide comparison</a>.',
          },
          {
            heading: "Cost and Availability",
            body: 'Brand-name tirzepatide costs over $1,000/month at retail price. Compounded versions through telehealth providers are significantly more affordable - typically $300-$500/month including consultations. See our <a href="/weight-loss/articles/weight-loss-medication-cost-guide">medication cost guide</a> for a full pricing breakdown.',
          ...
          },
          {
            ...
            body: 'Tirzepatide may be a better fit if you have significant weight loss goals or haven\'t seen enough results with semaglutide alone. Not sure if you qualify? Check our <a href="/weight-loss/articles/who-qualifies-for-glp1-weight-loss">eligibility guide</a> or <a href="/weight-loss/find-your-match">take our matching quiz</a> for a personalized recommendation.',
          },
        ],
      },
      {
        slug: "best-online-weight-loss-programs",
        seoTitle: "Best Online Weight Loss Programs of 2026",
        ...
        editorialSections: [
          ...
          },
          {
            ...
            body: 'The difference between a good and great program comes down to medical oversight, pricing transparency, and ongoing support. The best programs include everything in one monthly fee - medication, consultations, and follow-up care. Learn <a href="/weight-loss/articles/choosing-telehealth-weight-loss-provider">how to evaluate telehealth providers</a> before signing up.',
          },
          {
            heading: "GLP-1 Medications Used in These Programs",
            body: 'Most top programs offer <a href="/weight-loss/semaglutide">semaglutide</a> (Ozempic/Wegovy) and <a href="/weight-loss/tirzepatide">tirzepatide</a> (Mounjaro/Zepbound) - the two most effective GLP-1 medications for weight loss. Some offer both, while others specialize in one. Understand the difference in our <a href="/weight-loss/articles/tirzepatide-vs-semaglutide">comparison guide</a>.',
          },
          {
            heading: "Who Qualifies for These Programs?",
            body: 'Most programs require a BMI of 27+ with a weight-related condition, or a BMI of 30+. Medical history, current medications, and health status are also evaluated. Check our full <a href="/weight-loss/articles/who-qualifies-for-glp1-weight-loss">eligibility guide</a> or <a href="/weight-loss/find-your-match">take our quiz</a> to see which program fits you best.',
          },
        ],
      },
      {
        slug: "best-weight-loss-injections",
        seoTitle: "Best Weight Loss Injections of 2026 (GLP-1)",
        ...
        editorialSections: [
          ...
          },
          {
            ...
            body: 'Most patients notice appetite changes within the first two weeks, with meaningful weight loss visible by weeks 4-8. Side effects are most common during dose increases and typically improve over time. For a week-by-week timeline, read our <a href="/weight-loss/articles/first-month-weight-loss-medication">first month guide</a> and <a href="/weight-loss/articles/semaglutide-side-effects-guide">side effects guide</a>.',
          },
          {
            heading: "Cost of Weight Loss Injections",
            body: 'Brand-name injections cost $900-$1,400/month at retail price. Compounded versions through telehealth providers typically run $200-$500/month, often all-inclusive. For a complete pricing breakdown, see our <a href="/weight-loss/articles/weight-loss-medication-cost-guide">cost guide</a>. <a href="/weight-loss/find-your-match">Take our quiz</a> to find a provider that fits your budget.',
          },
        ],
      },
      {
        ...
        editorialSections: [
          ...
          },
          {
            ...
            body: 'Eligibility typically requires a BMI of 27+ with a weight-related condition, or a BMI of 30+. Your medical history and current medications will also be evaluated. Read our <a href="/weight-loss/articles/who-qualifies-for-glp1-weight-loss">full eligibility guide</a> for detailed criteria.',
          },
          {
            heading: "Side Effects and What to Expect",
            body: 'The most common side effects are gastrointestinal - nausea, diarrhea, and constipation - especially during dose increases. These typically improve over time. For management strategies, see our <a href="/weight-loss/articles/semaglutide-side-effects-guide">semaglutide side effects guide</a>. Not sure which provider is right for you? <a href="/weight-loss/find-your-match">Take our matching quiz</a>.',
          },
        ],
      },
      {
        slug: "wegovy-providers",
        seoTitle: "Best Wegovy Providers & Alternatives 2026",
        ...
        editorialSections: [
          {
            ...
            body: 'Wegovy is the brand-name semaglutide approved specifically for weight loss, with a maximum dose of 2.4 mg/week. Many telehealth providers now offer compounded semaglutide as a more affordable alternative using the same active ingredient. For a full comparison of the brand-name options, see <a href="/weight-loss/articles/ozempic-vs-wegovy-differences">Ozempic vs Wegovy</a>.',
          ...
          },
          {
            ...
            body: 'The STEP trials showed Wegovy patients lost an average of 15% of their body weight over 68 weeks - significantly more than lifestyle changes alone. Results begin with appetite changes in weeks 1-2, with visible weight loss around weeks 4-8. Read our <a href="/weight-loss/articles/first-month-weight-loss-medication">first month guide</a> for a week-by-week breakdown.',
          },
          {
            heading: "How to Choose the Right Provider",
            body: 'Whether you want brand-name Wegovy or a compounded alternative, the provider you choose matters. Look for licensed medical oversight, transparent pricing, and ongoing support. Read our <a href="/weight-loss/articles/choosing-telehealth-weight-loss-provider">provider selection guide</a> or <a href="/weight-loss/find-your-match">take our quiz</a> for a personalized match.',
          },
        ],
      },
      {
        ...
        editorialSections: [
          {
            ...
            body: 'Compounded versions of semaglutide and tirzepatide have made GLP-1 treatment accessible to far more patients. Licensed compounding pharmacies produce these medications using the same active ingredients at a fraction of the brand-name cost. Learn more in our <a href="/weight-loss/articles/weight-loss-medication-cost-guide">complete cost guide</a>.',
          },
          {
            heading: "What's Included in the Price",
            body: 'The best value providers bundle everything into one monthly fee. When comparing costs, make sure you\'re looking at the total - not just the medication price. Read <a href="/weight-loss/articles/choosing-telehealth-weight-loss-provider">how to evaluate providers</a> to avoid hidden fees.',
          ...
          },
          {
            ...
            body: '<a href="/weight-loss/find-your-match">Take our matching quiz</a> and we\'ll recommend providers that fit your goals and budget. You can also compare <a href="/weight-loss/semaglutide">semaglutide providers</a> or <a href="/weight-loss/tirzepatide">tirzepatide providers</a> specifically.',
          },
        ],
      },
    ],
