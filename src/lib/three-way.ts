...
export const TRIO_FACTS: Record<string, TrioFacts> = {
  ...
  medvi: {
    ...
    guarantee: "-",
    standout: "4.3 on Trustpilot across 14,836 reviews",
  },
  healthrx: {
    id: "healthrx",
...
export const THREE_WAY_COMPARISONS: ThreeWayComparison[] = [
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Medvi has the strongest verified review record of the three - 4.3 on Trustpilot across 14,836 reviews, with support and communication the recurring themes. embody holds 3.8 across 8,398 reviews. Current ratings for each provider are shown on their cards above.",
      },
      {
  ...
  },
  {
    ...
    description:
      "Three verified Trustpilot records, three ways to buy the same compounded GLP-1s: embody ($69 flat), Medvi ($99 all-inclusive, 4.3 across 14,836 reviews) and wellmedr ($49 on a 12-month plan, 4.7 rated).",
    intro:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "wellmedr holds the highest rating of the three - 4.6 across 1,919 reviews. Medvi has the largest verified base: 4.3 across 14,836 reviews. embody sits at 3.8 across 8,398. All three figures are the providers' live Trustpilot aggregates at our last verification.",
      },
      {
  ...
  },
  {
    ...
    intro:
      "Three providers, three completely different bets. Medvi bets on people: video visits, dietician, coaching, and 14,836 Trustpilot reviews averaging 4.3. HealthRx bets on logistics: $99/month semaglutide (12-month prepaid, $1,188 at checkout) with overnight cold-chain delivery. DirectMeds bets on simplicity: one flat $147 for either medication, injections or needle-free sublingual drops, no membership. The matrix below puts the three bets side by side.",
    verdict:
