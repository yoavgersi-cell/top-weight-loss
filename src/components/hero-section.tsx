    ...
    <section className="relative w-full h-[160px] sm:h-[270px] lg:h-[300px] overflow-hidden bg-[#f5f5f7]">
      ...
      >
        <div style={{ maxWidth: maxTextWidth }}>
          {updatedLabel && (
            <span className="mb-2 sm:mb-3 inline-flex items-center gap-1.5 text-[12px] sm:text-[13px] text-gray-500">
          ...
          <h1 className="text-[22px] sm:text-[32px] leading-[1.15] font-extrabold text-[#191919]">
            {h1}
          </h1>

          {h2 && (
            <h2 className="mt-0.5 sm:mt-1 text-[16px] sm:text-[24px] leading-[1.25] font-semibold text-[#3a6ea5]">
              {h2}
            </h2>
          )}

          {description && (
            <p className="mt-3 text-[13px] sm:text-[15px] leading-[1.6] text-gray-500 max-w-[520px]">
              {description}
            </p>
          )}
        </div>
