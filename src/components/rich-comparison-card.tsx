      ...
      <div className="p-4 sm:p-7">
        ...
        <div className="flex flex-row items-center justify-between gap-3 sm:gap-4">
          <div className="flex items-center gap-2.5 sm:gap-3.5">
            <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#191919] text-[12px] font-extrabold text-white sm:h-8 sm:w-8 sm:text-[13px]">
              {product.rank}
            </span>
          ...
          <div className="flex shrink-0 items-center gap-2 sm:gap-3">
            <div className="text-right">
              ...
              <p className="mt-0.5 text-[10px] font-bold uppercase tracking-wide text-[#0C4B75] sm:text-[11px]">{product.ratingLabel}</p>
            </div>
            <div className="flex flex-col items-center justify-center rounded-lg bg-[#0C4B75] px-2.5 py-1 text-white sm:rounded-xl sm:px-3 sm:py-1.5">
        ...
        <div className="mt-4 flex flex-col gap-4 sm:mt-5 sm:gap-5 lg:flex-row lg:items-start">
          <div className="min-w-0 flex-1 space-y-3.5 sm:space-y-4">
            ...
            {(treatments.length > 0 || startingPlan?.price) && (
              <div className="rounded-xl border border-gray-100 bg-[#F7F8FA] p-3.5 sm:p-4">
                {treatments.length > 0 && (
                  <div>
                    <p className="text-[10.5px] font-bold uppercase tracking-wide text-gray-500 sm:text-[11px]">Treatments offered</p>
