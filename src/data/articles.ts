  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'At verified published prices, <a href="/reviews/altrx">altRx</a> lists brand Ozempic at $1,149/month and Wegovy at $1,579, <a href="/reviews/sprout">Sprout</a> lists Wegovy at $1,799, and <a href="/reviews/ro">ro</a> lists the Wegovy pill at $149 for the first month (then $299, plus a separate membership). Most self-pay patients skip both brands and use compounded semaglutide - the same active ingredient - through licensed telehealth providers:<table><tr><th>Provider</th><th>Compounded semaglutide</th></tr><tr><td><a href="/reviews/wellmedr">wellmedr</a></td><td><strong>$59/mo</strong> (12-month plan)</td></tr><tr><td><a href="/reviews/embody">embody</a></td><td>$69/mo, no commitment</td></tr><tr><td><a href="/reviews/altrx">altRx</a></td><td>$89/mo flat</td></tr><tr><td><a href="/reviews/medvi">Medvi</a></td><td>$99/mo promo (reg. $199), all-inclusive</td></tr></table>Prices as published in August 2026, checked against each provider\'s own site. Full breakdown: <a href="/articles/semaglutide-cost-per-month">semaglutide monthly cost guide</a> and the <a href="/cheapest-glp1">cheapest verified GLP-1 comparison</a>.',
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'At verified published prices: <a href="/reviews/altrx">altRx</a> lists Zepbound at $1,249/month and Wegovy at $1,579, <a href="/reviews/sprout">Sprout</a> lists Wegovy at $1,799, and <a href="/reviews/ro">ro</a> lists Zepbound KwikPens from $299 for the first month (then $399-449, plus a separate membership). Insurance coverage is limited for both. Compounded versions of the same active ingredients cost far less through licensed telehealth providers: compounded semaglutide from a verified <strong>$59/month</strong> (<a href="/reviews/wellmedr">wellmedr</a>) and compounded tirzepatide from <strong>$99/month</strong>. Prices as published in August 2026 - see the <a href="/cheapest-glp1">cheapest verified GLP-1 comparison</a> for the full table.',
      },
      {
      ...
      },
      {
        ...
        body: 'Yes - both Wegovy (semaglutide) and Zepbound (tirzepatide) have compounded versions available through licensed telehealth providers at a fraction of brand pricing: compounded semaglutide from a verified $59/month and compounded tirzepatide from $99/month at <a href="/reviews/wellmedr">wellmedr</a>, with <a href="/reviews/embody">embody</a> ($69/$119) and <a href="/reviews/altrx">altRx</a> ($89/$149) close behind. Read our <a href="/articles/compounded-semaglutide-vs-brand-name">compounded vs brand-name guide</a> for details on quality and safety.',
      },
      {
